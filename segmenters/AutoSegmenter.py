...
METHODS_BY_LIBRARY: Dict[str, Dict[str, MethodProfile]] = {
    ...
    "torch_v2": {
        "global_thresholding": MethodProfile(
            ...
            robustness=0.4,
            parameter_sensitivity=0.9,
            description="Простое глобальное пороговое значение (torch_v2)",
            params={"threshold": 0.5},
            schema={
                "threshold": {
                    "type": "float",
        ...
        "otsu_thresholding": MethodProfile(
            ...
            robustness=0.8,
            parameter_sensitivity=0.2,
            description="Автоматический порог Оцу (максимизация межклассовой дисперсии) (torch_v2)",
            params={},
            schema={},
        ),
        "adaptive_thresholding": MethodProfile(
            ...
            robustness=0.9,
            parameter_sensitivity=0.4,
            description="Адаптивный порог с локальным усреднением (torch_v2)",
            schema={
                "block_size": {
                    "type": "int",
                    "min": 3,
        ...
        "threshold_niblack": MethodProfile(
            ...
            robustness=0.6,
            parameter_sensitivity=0.7,
            description="Метод Ниблэка для локального порогования (torch_v2)",
            params={"window_size": 15, "k": -0.2},
            schema={
                "window_size": {
                    "type": "int",
        ...
        "threshold_sauvola": MethodProfile(
            ...
            robustness=0.92,
            parameter_sensitivity=0.3,
            description="Метод Саволы (улучшенный Ниблэк для текста) (torch_v2)",
            params={"window_size": 15, "k": 0.5, "r": 128},
            schema={
                "window_size": {
                    "type": "int",
        ...
        "threshold_bernsen": MethodProfile(
            ...
            robustness=0.7,
            parameter_sensitivity=0.5,
            description="Метод Бернсена на основе локального контраста (torch_v2)",
            params={"window_size": 15, "contrast_threshold": 0.15},
            schema={
                "window_size": {
                    "type": "int",
        ...
        "threshold_phansalkar": MethodProfile(
            ...
            robustness=0.88,
            parameter_sensitivity=0.4,
            description="Метод Фансалкара для низкоконтрастных изображений (torch_v2)",
            params={"window_size": 15, "k": 0.25, "r": 128.0, "m": 0.5},
            schema={
                "window_size": {
                    "type": "int",
        ...
        "threshold_kittler_illingworth": MethodProfile(
            ...
            robustness=0.75,
            parameter_sensitivity=0.3,
            description="Минимизация ошибки классификации (Киттлер-Иллингуорт) (torch_v2)",
            params={"num_bins": 256},
            schema={
                "num_bins": {
                    "type": "int",
        ...
        "threshold_entropy_kapur": MethodProfile(
            ...
            robustness=0.7,
            parameter_sensitivity=0.4,
            description="Максимизация энтропии (Капур) (torch_v2)",
            params={"num_bins": 256},
            schema={
                "num_bins": {
                    "type": "int",
        ...
        "threshold_triangle": MethodProfile(
            ...
            robustness=0.65,
            parameter_sensitivity=0.3,
            description="Треугольный метод для унимодальных гистограмм (torch_v2)",
            params={"num_bins": 256},
            schema={
                "num_bins": {
                    "type": "int",
        ...
        "threshold_multi_otsu": MethodProfile(
            ...
            robustness=0.8,
            parameter_sensitivity=0.5,
            description="Многопороговый Оцу для многоклассовой сегментации (torch_v2)",
            params={"n_thresholds": 2},
            schema={
                "n_thresholds": {
                    "type": "int",
        ...
        "threshold_percentile": MethodProfile(
            ...
            robustness=0.5,
            parameter_sensitivity=0.8,
            description="Порог по перцентилю интенсивности (torch_v2)",
            params={"percentile": 90},
            schema={
                "percentile": {
                    "type": "int",
        ...
        "threshold_local_contrast": MethodProfile(
            ...
            robustness=0.82,
            parameter_sensitivity=0.5,
            description="Порог на основе локального контраста (torch_v2)",
            params={"window_size": 15, "contrast_factor": 0.1},
            schema={
                "window_size": {
                    "type": "int",
        ...
        "canny_edge": MethodProfile(
            ...
            robustness=0.7,
            parameter_sensitivity=0.6,
            description="Детектор границ Кэнни (оптимальный по Кэнни) (torch_v2)",
            params={"low": 0.1, "high": 0.3, "sigma": 1.0},  # ← дефолтные значения
            schema={  # ← ДОБАВЬТЕ СХЕМУ
                "low": {
                    "type": "float",
        ...
        "sobel_edge": MethodProfile(
            ...
            robustness=0.5,
            parameter_sensitivity=0.7,
            description="Градиенты Собеля с порогом (torch_v2)",
            params={"threshold": 0.1},
            schema={
                "threshold": {
                    "type": "float",
        ...
        "prewitt_edge": MethodProfile(
            ...
            robustness=0.48,
            parameter_sensitivity=0.72,
            description="Градиенты Превитта с порогом (torch_v2)",
            params={"threshold": 0.1},
            schema={
                "threshold": {
                    "type": "float",
        ...
        "scharr_edge": MethodProfile(
            ...
            robustness=0.55,
            parameter_sensitivity=0.65,
            description="Градиенты Шарра (torch_v2)",
            params={"threshold": 0.1},
            schema={
                "threshold": {
                    "type": "float",
        ...
        "roberts_cross_edge": MethodProfile(
            ...
            robustness=0.4,
            parameter_sensitivity=0.8,
            description="Оператор Робертса для диагональных границ (torch_v2)",
            params={"threshold": 0.1},
            schema={
                "threshold": {
                    "type": "float",
        ...
        "log_edge": MethodProfile(
            ...
            robustness=0.6,
            parameter_sensitivity=0.5,
            description="Laplacian of Gaussian детектор границ (torch_v2)",
            schema={
                "sigma": {
                    "type": "float",
                    "min": 0.1,
        ...
        "dog_edge": MethodProfile(
            ...
            robustness=0.68,
            parameter_sensitivity=0.55,
            description="Difference of Gaussians для мультимасштабных границ (torch_v2)",
            params={"sigma1": 1.0, "sigma2": 2.0, "threshold": 0.01},
            schema={
                "sigma1": {
                    "type": "float",
        ...
        "marr_hildreth_edge": MethodProfile(
            ...
            robustness=0.62,
            parameter_sensitivity=0.58,
            description="Метод Марра-Хилдрета (нулевые пересечения LoG) (torch_v2)",
            params={"sigma": 1.5, "threshold": 0.01},
            schema={
                "sigma": {
                    "type": "float",
        ...
        "gradient_magnitude_direction": MethodProfile(
            ...
            robustness=0.52,
            parameter_sensitivity=0.68,
            description="Сегментация по величине и направлению градиента (torch_v2)",
            params={"threshold": 0.1},
            schema={
                "threshold": {
                    "type": "float",
        ...
        "phase_congruency_edge": MethodProfile(
            ...
            robustness=0.95,
            parameter_sensitivity=0.3,
            description="Фазовая конгруэнтность (инвариантна к освещению) (torch_v2)",
            params={
                "nscales": 4,
                "norientations": 4,
                "min_wavelength": 3,
        ...
        "region_growing": MethodProfile(
            ...
            robustness=0.75,
            parameter_sensitivity=0.6,
            description="Рост региона от семян по схожести (torch_v2)",
            params={"tolerance": 0.1},
            schema={
                "tolerance": {
                    "type": "float",
        ...
        "split_and_merge": MethodProfile(
            ...
            robustness=0.7,
            parameter_sensitivity=0.5,
            description="Разделение и слияние регионов (torch_v2)",
            params={"min_size": 50, "threshold": 20},
            schema={
                "min_size": {
                    "type": "int",
        ...
        "floodfill": MethodProfile(
            ...
            robustness=0.6,
            parameter_sensitivity=0.7,
            description="Заливка области от точки (torch_v2)",
            params={"tolerance": 0.15},
            schema={
                "tolerance": {
                    "type": "float",
        ...
        "kmeans_segmentation": MethodProfile(
            ...
            robustness=0.65,
            parameter_sensitivity=0.7,
            description="K-means кластеризация в пространстве признаков (torch_v2)",
            params={"k": 3},
            schema={
                "k": {
                    "type": "int",
        ...
        "dbscan_segmentation": MethodProfile(
            ...
            robustness=0.8,
            parameter_sensitivity=0.6,
            description="DBSCAN для сегментации произвольной формы (torch_v2)",
            params={"eps": 0.1, "min_samples": 10},
            schema={
                "eps": {
                    "type": "float",
        ...
        "meanshift": MethodProfile(
            ...
            robustness=0.85,
            parameter_sensitivity=0.4,
            description="MeanShift с пространственно-цветовым ядром (torch_v2)",
            params={
                "bandwidth": 0.5,
                "spatial_radius": 35,
                "color_radius": 60,
        ...
        "active_contour": MethodProfile(
            ...
            robustness=0.78,
            parameter_sensitivity=0.75,
            description="Змеи (snakes) с энергией границ и линий (torch_v2)",
            params={
                "alpha": 0.015,
                "beta": 10,
                "gamma": 0.001,
        ...
        "gvf_contour": MethodProfile(
            ...
            robustness=0.88,
            parameter_sensitivity=0.5,
            description="Контуры с градиентным векторным потоком (GVF) (torch_v2)",
            params={"mu": 0.1, "iterations": 50},
            schema={
                "mu": {
                    "type": "float",
        ...
        "morphological_snakes": MethodProfile(
            ...
            robustness=0.92,
            parameter_sensitivity=0.35,
            description="Морфологические змеи (устойчивы к шуму) (torch_v2)",
            params={"iterations": 100, "smoothing": 1, "threshold": 0.5},
            schema={
                "iterations": {
                    "type": "int",
        ...
        "chan_vese": MethodProfile(
            ...
            robustness=0.94,
            parameter_sensitivity=0.3,
            description="Модель Чан-Везе (регион-базированные активные контуры) (torch_v2)",
            params={
                "mu": 0.25,
                "lambda1": 1.0,
                "lambda2": 1.0,
        ...
        "watershed": MethodProfile(
            ...
            robustness=0.65,
            parameter_sensitivity=0.8,
            description="Классический watershed по градиенту (torch_v2)",
            params={},
            schema={},
        ),
        "random_walker": MethodProfile(
            ...
            robustness=0.9,
            parameter_sensitivity=0.4,
            description="Random walker с вероятностной диффузией (torch_v2)",
            params={
                "beta": 130,
                "tol": 1e-3,
                "max_iter": 300,
        ...
        "slic": MethodProfile(
            ...
            robustness=0.8,
            parameter_sensitivity=0.4,
            description="SLIC super-pixels в Lab-пространстве (torch_v2)",
            params={
                "n_segments": 100,
                "compactness": 10.0,
                "max_iter": 10,
        ...
        "felzenszwalb": MethodProfile(
            ...
            robustness=0.78,
            parameter_sensitivity=0.5,
            description="Граф-базированная сегментация Фельценцвальба (torch_v2)",
            params={"scale": 100, "sigma": 0.5, "min_size": 50},
            schema={
                "scale": {
                    "type": "int",
        ...
        "grabcut": MethodProfile(
            ...
            robustness=0.88,
            parameter_sensitivity=0.5,
            description="GrabCut с итеративной оптимизацией GMM (torch_v2)",
            params={"num_iterations": 5},
            schema={
                "num_iterations": {
                    "type": "int",
