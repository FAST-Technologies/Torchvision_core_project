...
class TestSklearnSegmenter:
    ...
    def test_segment_grayscale_normalized(self):
    ...
    def test_sauvola_with_r_parameter(self, gray_image):
    ...
    def test_canny_with_quantiles(self, rgb_image):
    ...
    def test_preprocess_image_as_gray(self, rgb_image):
