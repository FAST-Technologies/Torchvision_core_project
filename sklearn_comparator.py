...
from sklearn_segmenter import SklearnSegmenter
# from opencv_segmenter import OpenCVSegmenter  # если у вас есть OpenCVSegmenter
...
class SklearnSegmentationComparator:
    ...
    def compare_sklearn_methods(self,
                              ...
                              output_dir: str = "sklearn_comparison") -> pd.DataFrame:
        """
...
def demo_comparator():
    ...
    try:
        comparison_result = comparator.compare_with_opencv(
            ...
            opencv_params={},
            output_path="sklearn_vs_opencv.jpg"
        )
